    ...
    <section class="main">
        <div class="login-container">
            ...
            <div class="separator"></div>
                <form  class="login-form" action="reset-code.php" method="POST" autocomplete="off">
                    ...
                    if(count($errors) > 0){
                        ?>
                        <div style= "text-align:center;margin:20px; background-color:rgba(255, 99, 71, 0.1);">
                            <?php
                    ...
                    <div class="form-control">
                        ...
                        <button class="submit" type="submit" name="check-reset-otp" value="Submit">Submit</button>
